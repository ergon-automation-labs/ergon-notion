defmodule BotArmyNotion.HTTPClient do
  @moduledoc """
  ...
  Pass http_client as an option in init:
      def init(opts) do
        http_client = Keyword.get(opts, :http_client, BotArmyNotion.HTTPClient.Req)
...
defmodule BotArmyNotion.HTTPClient.Req do
  @moduledoc """
  Real HTTP client implementation using the Req library.
  """

  @behaviour BotArmyNotion.HTTPClient
