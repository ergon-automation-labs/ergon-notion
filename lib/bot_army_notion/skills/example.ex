defmodule BotArmyNotion.Skills.Example do
  @moduledoc """
  Example skill for Notion Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_notion.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_notion.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_notion/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_notion.command.example"
    ]
  end
