defmodule BotArmyNotion.ExampleTest do
  @moduledoc """
  ...
  describe "module initialization" do
    test "application starts without errors" do
      assert BotArmyNotion.Application != nil
    end
  end
  ...
  describe "pulse publisher" do
    test "pulse publisher module exists" do
      ...
      assert module_exists?(BotArmyNotion.PulsePublisher)
    end
  end
  ...
  describe "http client behavior" do
    test "http client behavior is defined" do
      ...
      assert module_exists?(BotArmyNotion.HTTPClient)
      assert module_exists?(BotArmyNotion.HTTPClient.Req)
    end
  end
