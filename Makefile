...
release: check
	...
	@echo "==============================================="
	rm -rf _build/prod/rel/notion_bot
	MIX_ENV=prod $(MIX) release
	@echo ""
	@echo "✓ Release built successfully"
	@echo "Location: _build/prod/rel/notion_bot/"
	@echo ""
...
publish-release: release
	...
	TARBALL="notion_bot-$$VERSION.tar.gz"; \
	echo "Version: $$VERSION"; \
	echo "Creating release tarball..."; \
	tar -czf "$$TARBALL" -C _build/prod/rel notion_bot/; \
	...
	if gh release view "v$$VERSION" >/dev/null 2>&1; then \
		...
		gh release create "v$$VERSION" "$$TARBALL" \
			...
			--notes "Notion Bot Elixir release v$$VERSION. Download and deploy with Jenkins." \
			--draft=false; \
	fi; \
